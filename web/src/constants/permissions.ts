...
const permissionFallbackNames: Record<string, { zhHans: string; enUS: string }> = {
  ...
  'database.view': { zhHans: '查看数据库', enUS: 'View databases' },
...
export const PERMISSION_DEPENDENCIES: Partial<Record<PermissionCode, readonly PermissionCode[]>> = {
  ...
  'database.create': ['database.view'],
  'database.update': ['database.view'],
  'database.delete': ['database.view'],
  'database.move': ['database.view'],
  'database.schema.view': ['database.view'],
  'database.schema.manage': ['database.view', 'database.schema.view'],
  'database.record.view': ['database.view', 'database.schema.view'],
  'database.record.create': ['database.view', 'database.schema.view', 'database.record.view'],
  'database.record.update': ['database.view', 'database.schema.view', 'database.record.view'],
  'database.record.delete': ['database.view', 'database.schema.view', 'database.record.view'],
  'database.import.analyze': ['database.view'],
  'database.import.execute': ['database.view', 'database.import.analyze'],
  'database.ai_query.read': ['database.view', 'database.record.view'],
  'database.sql_audit.view': ['database.view'],
  'database.operation_logs.view': ['database.view'],
  'knowledge_base.create': ['knowledge_base.view'],
  'knowledge_base.update': ['knowledge_base.view'],
  'knowledge_base.delete': ['knowledge_base.view'],
  'knowledge_base.move': ['knowledge_base.view'],
  'knowledge_base.folder_manage': ['knowledge_base.view'],
  'knowledge_base.retrieval_test': ['knowledge_base.view'],
  'knowledge_base.document.view': ['knowledge_base.view'],
  'knowledge_base.document.create': ['knowledge_base.view', 'knowledge_base.document.view'],
  'knowledge_base.document.update': ['knowledge_base.view', 'knowledge_base.document.view'],
  'knowledge_base.document.delete': ['knowledge_base.view', 'knowledge_base.document.view'],
  'knowledge_base.segment.update': ['knowledge_base.view', 'knowledge_base.document.view'],
  'knowledge_base.segment.delete': ['knowledge_base.view', 'knowledge_base.document.view'],
  'knowledge_base.index.manage': ['knowledge_base.view', 'knowledge_base.document.view'],
  'knowledge_base.graph.view': ['knowledge_base.view'],
  'knowledge_base.graph.manage': ['knowledge_base.view', 'knowledge_base.graph.view'],
};
