      ...
      <TableRow className="text-xs">
        {columns.map(col => {
          ...
          const headClassName = cn(
            'sticky top-0 z-10 h-8 min-w-[140px] max-w-[280px] border-r bg-muted/50 last:border-r-0',
        ...
        {(isEditing || showRowActions) && (
          <TableHead
            className="sticky top-0 right-0 z-30 h-8 max-w-[400px] border-r bg-muted/50 shadow-[-1px_0_0_hsl(var(--border))]"
            title={actionsTitle}
          >
            {actionsTitle}
          </TableHead>
