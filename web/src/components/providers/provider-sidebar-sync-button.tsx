...
export function ProviderSidebarSyncButton() {
  ...
  return (
    <>
      <Button variant="ghost" size="sm" className="h-8 gap-1.5 px-2" onClick={() => setOpen(true)}>
        ...
        <span className="text-xs">{t('syncStatus.triggerShort')}</span>
      </Button>
      <ProviderSyncDialog
        open={open}
