...
const LoopStartNode: React.FC<NodePropsCompat<LoopStartNodeData>> = ({ id }) => {
  ...
  return (
    ...
    >
      <div className="w-6 h-6 rounded-lg bg-blue-500/90 flex items-center justify-center shadow-[0_0_12px_rgba(59,130,246,0.4)]">
