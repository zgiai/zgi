const messages = {
  ...
  permissionSummary: {
    ...
    availableCapabilities: 'ZGI capabilities',
    providerScopeCount: 'Provider grants',
    needsAttention: 'Needs attention',
    capabilitiesTitle: 'Capabilities available to ZGI',
    capabilitiesDescription:
      'Only actions currently adapted and safe to invoke are shown in this section.',
  ...
  executions: {
    description:
      'Audit metadata only. Queries, credentials, and provider response bodies are not stored.',
