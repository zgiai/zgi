...
const messages: WebappMessages = {
  ...
  appLogs: {
    ...
    runtimeRawDebugTrace: '原始调试 Trace',
    runtimeRawDebugTraceDescription: '仅在后端短期原始模型追踪开启时可用。',
    runtimeRawDebugTraceLoad: '加载原始 Trace',
    runtimeRawDebugTraceLoading: '正在加载原始 Trace...',
    runtimeRawDebugTraceUnavailable: '当前模型调用没有可用的原始调试 Trace。',
