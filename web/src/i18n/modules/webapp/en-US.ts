const messages = {
  chat: {
    ...
    videoWorkbench: {
      ...
      referenceImageHint: 'Reserved for image-to-video input. Upload support will be connected with the video API.',
      ...
      submitHint: 'The interface is ready. Real generation will be enabled after the video runtime API is connected.',
      ...
      supportedModelsDescription: 'Shows enabled models that support video generation in the current workspace.',
      emptyModelsTitle: 'No video models available',
      emptyModelsDescription: 'Configure a model route that supports video-gen, then refresh this page.',
      ...
      emptyRecordsDescription: 'After the video API is connected, submitted tasks and generated videos will appear here.',
