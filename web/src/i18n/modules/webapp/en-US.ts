const messages = {
  chat: {
    ...
    imageInput: {
      ...
      replaceReference: 'Replace attachment',
      uploadImage: 'Upload image',
      selectFromFiles: 'Choose from files',
      removeReference: 'Remove reference image',
      imageOnly: 'Only images are supported.',
      invalidImageContent: 'The reference file is not a valid image. Upload another image.',
      promptLengthCounter: '{count}/{max}',
      promptTooLong: 'The prompt cannot exceed {max} characters. Shorten it and try again.',
      defaultReferencePrompt: 'Generate a new image based on the reference image.',
      generatingShort: 'Generating',
      taskRunning: 'Image generation is in progress...',
      taskGenerated: 'Image generated',
      taskCancelled: 'Image generation cancelled',
      taskTimeout: 'Image generation timed out. Please try again later.',
      taskProviderFailed: 'The image generation service failed. Please try again later.',
      taskFailed: 'Image generation failed',
      taskStillRunning: 'Image generation is still running. Refresh later to view the result.',
      uploadFailed: 'Failed to upload the reference image.',
      selectFailed: 'Failed to select the reference image.',
      previewUrlMissing: 'The reference image is not accessible. Try another image.',
      aspectRatios: {
        square: 'Square',
        portrait: 'Portrait',
        landscape: 'Landscape',
    ...
    videoWorkbench: {
      uiOnlyBadge: 'UI preview',
      heroTitle: 'Start creating your video',
      generatorTitle: 'Video generation',
      generatorDescription:
        'Upload reference assets, type prompts, or @ mention references to combine images, text, audio, and video.',
      promptLabel: 'Prompt',
      promptPlaceholder: 'Enter your idea to start creating',
      modelLabel: 'Model',
      referenceImage: 'Reference image',
      referenceImageHint:
        'Reserved for image-to-video input. Upload support will be connected with the video API.',
      referenceMaterial: 'Image/video/audio',
      referenceTextOnly: 'Text only',
      referenceKinds: {
        image: 'Image',
        video: 'Video',
        audio: 'Audio',
      ...
      referenceUploadPending: 'Reference asset upload is not connected yet.',
      referenceUploadNoUrl: 'No accessible URL was returned after uploading the reference asset.',
      specTitle: 'Generation specs',
      ...
      secondsSuffix: 's',
      videoMode: 'Video',
      referenceModeAuto: 'All references',
      referenceModeFirstLastFrame: 'First/last frame',
      referenceFirstLastFrameMaterial: 'First/last images',
      firstFrame: 'First frame',
      lastFrame: 'Last frame',
      referenceModeNone: 'No reference',
      referenceModePriceHint:
        'Reference mode can affect billing dimensions. Final points are deducted by model pricing, input type, and upstream usage.',
      aspectRatioPriceHint:
        'Aspect ratio can affect generation specs and final video tokens. Usage comes from the upstream response.',
      resolutionPriceHint:
        'Resolution may use different model rates. Deduction is calculated from the selected resolution and upstream usage.',
      durationPriceHint:
        'Duration usually affects video tokens. Deduction is calculated after generation from upstream usage.',
      referenceModePriceHintShort: 'Mode',
      aspectRatioPriceHintShort: 'Ratio',
      resolutionPriceHintShort: 'Resolution',
      durationPriceHintShort: 'Duration',
      submitHint:
        'The interface is ready. Real generation will be enabled after the video runtime API is connected.',
      generate: 'Generate video',
      pendingApiToast: 'Video generation API is not connected yet.',
      submitSuccess: 'Video task submitted.',
      submitFailed: 'Failed to submit video task.',
      submitting: 'Submitting',
      confirmTitle: 'Generate this video?',
      confirmDescription:
        'Video generation can be expensive. Review the generation settings before submitting.',
      confirmCostNotice:
        'Points are deducted based on the selected model, duration, resolution, and actual usage.',
      ...
      estimatedPrice: '0.046 CNY / 1K tokens',
      refreshModels: 'Refresh models',
      loadingModels: 'Loading models',
      supportedModelsTitle: 'Supported video models',
      supportedModelsDescription:
        'Shows enabled models that support video generation in the current workspace.',
      emptyModelsTitle: 'No video models available',
      emptyModelsDescription:
        'Configure a model route that supports video-gen, then refresh this page.',
      modelsLoadFailed: 'Failed to load video models.',
      configured: 'Configured',
      recordsTitle: 'Generation records',
      recordsDescription: 'Video tasks, status, parameters, and results will be listed here.',
      recordsCount: '{count} records',
      emptyRecordsTitle: 'No video generation records yet',
      emptyRecordsDescription:
        'After the video API is connected, submitted tasks and generated videos will appear here.',
      recordMetaHint: 'Records will include model, specs, duration, status, and result preview.',
      searchRecords: 'Search tasks',
      searchEmptyTitle: 'No matching videos found',
      loadingRecords: 'Loading video records',
      loadingMoreRecords: 'Loading more',
      loadMoreRecords: 'Load more',
      allRecordsLoaded: 'All records loaded',
      recordsLoadFailed: 'Failed to load video records',
      retry: 'Retry',
      estimatedCredits: 'Estimated credits',
      actualCredits: 'Actual credits',
      deductedCredits: 'Deducted points',
      createdAt: 'Created',
      updatedAt: 'Updated',
  ...
  consoleChat: {
    ...
    voice: {
      ...
      autoPlay: 'Automatically play new replies',
      playResponse: 'Play response',
      pausePlayback: 'Pause playback',
      cancelPlayback: 'Cancel speech generation',
      errors: {
        ...
        noSpeech: 'No speech was detected. Please record again.',
        timeout: 'Voice transcription timed out. Please try again.',
        balance: 'The organization balance is insufficient for voice transcription.',
        quota: 'The voice transcription quota is exhausted.',
        unavailable: 'Voice transcription is temporarily unavailable.',
        failed: 'Voice transcription failed. Please try again.',
        playbackTimeout: 'Speech generation timed out. Please try again.',
        playbackBalance: 'The organization balance is insufficient for speech generation.',
        playbackQuota: 'The speech generation quota is exhausted.',
        playbackUnavailable:
          'Speech generation is unavailable. Ask an administrator to check the default TTS model, voice, and channel.',
        playbackFailed: 'Speech playback failed. Please try again.',
      },
    },
    ...
    governance: {
      ...
      externalToolLabel: '{integration} · {action}',
      approvalPanel: {
        ...
        externalAction: 'Run {action} in {integration} using connection {connection}.',
        preferredConnection: 'Preferred AIChat connection',
        selectedConnection: 'Selected AIChat connection',
        otherArgument: 'Other parameter',
      ...
      reasons: {
        persistentAuthorizationRequired: 'This action requires persistent preauthorization.',
        persistentAuthorizationMatched: 'A previously granted persistent authorization matched.',
        interactiveApprovalUnavailable: 'Interactive approval is unavailable in this runtime.',
        resourceNotBound: 'The requested resource is not bound to the current runtime.',
        externalSideEffect: 'This action affects an external system and requires confirmation.',
        policyDecision: 'This result was determined by the current tool and organization policy.',
      },
      audit: {
        action: 'Asset audit',
    ...
    skillPreferences: {
      ...
      savedWithChanges: 'Settings saved, but some Skills are unavailable and were adjusted.',
      ...
      closeConfirm: {
        title: 'Close Skill Management?',
        description: 'You have unsaved Skill setting changes. Choose how to close this panel.',
    ...
    connectedApps: {
      action: 'External Apps ({count} selected for AIChat)',
      title: 'AIChat External Apps',
      description:
        'Choose which external connections become candidate tools for AIChat in the current workspace. AIChat only attempts them when the request needs them and policy allows it.',
      statusExplanation:
        'Status guide: a successful test or Healthy status only verifies the credential and provider API. Selected for AIChat only makes the connection available to the model. An actual call is confirmed only by a tool-call result in the conversation.',
      searchPlaceholder: 'Search apps or connections',
      loadFailed: 'Connected apps could not be loaded.',
      retry: 'Retry',
      empty: 'No external app provider is available in this deployment.',
      noResults: 'No apps or connections match this search.',
      unknownExternalApp: 'External app',
      unnamedConnection: 'Unnamed connection',
      noAuthorizedConnections:
        'You do not have access to a usable connection for this app. Add a personal connection or ask an administrator to grant access.',
      managePersonal: 'Manage my personal connections',
      addPersonal: 'Add my connection',
      selectedCount: '{count} selected for AIChat',
      notSelected: 'Not available to AIChat',
      totalSelected: '{count} connection(s) selected for AIChat in this workspace',
      selectConnection: 'Select connection {name}',
      preferred: 'Preferred',
      makePreferred: 'Make preferred',
      preferredDescription:
        'AIChat tries the preferred connection first when this app has multiple selected connections.',
      preferredConnectionLabel: '{name} is the current preferred connection',
      makePreferredConnectionLabel: 'Make {name} the preferred connection',
      reconnectRequired: 'Reconnect required',
      expired: 'Expired',
      scopeChanged: 'Permissions changed',
      missingSelections:
        '{count} previously selected connection(s) are no longer accessible. Saving removes them from AIChat.',
      credentialSource: {
      ...
      providers: {
        github: {
          name: 'GitHub',
          description:
            'Read authorized repositories, issues, and account details through the GitHub REST API.',
        },
        webSearch: {
          name: 'Web Search',
          description: 'Search public webpages and read relevant content through Exa.',
        },
        genericDescription:
          'Let AIChat securely use this external app through an authorized connection.',
      },
      actions: {
      ...
      cancel: 'Cancel',
      saved:
        'AIChat external app selection saved. Actual use still depends on the request, policy, and model.',
      saveFailed: 'Failed to save the AIChat external app selection',
      closeConfirm: {
        title: 'Close Connected Apps?',
        description: 'You have unsaved connection selection changes.',
    ...
    skills: {
      trace: {
        ...
        kinds: {
          skillLoad: 'Load Skill',
          referenceRead: 'Read reference',
          toolCall: 'Tool call',
          guardrail: 'Safety adjustment',
          runtimeEvent: 'Runtime event',
        },
        argumentTypes: {
          string: 'String ({count} characters)',
          array: 'Array ({count} items)',
          object: 'Object ({count} fields)',
          number: 'Number',
          boolean: 'Boolean',
          unknown: 'Value',
        },
        ...
        values: {
          ...
          lessThanOneMillisecond: 'Less than 1 ms',
        },
        errors: {
          externalAppFailed: 'The external app request failed. Try again later.',
          invalidArguments: 'The tool arguments were invalid. No external request was sent.',
          integrationDisabled: 'This external app is currently disabled.',
          invalidInput: 'The external app arguments are invalid.',
          sensitiveInputBlocked:
            'Sensitive information was detected and was not sent to the external app.',
          quotaExceeded: "Today's usage limit for this external app has been reached.",
          authInvalid: 'The connection credentials are invalid. Reconnect and try again.',
          budgetExceeded: 'The external service account has insufficient balance or budget.',
          accessDenied: 'Your account is not allowed to perform this action.',
          ...
          connectionConflict: 'The connection configuration changed. Refresh and try again.',
          connectionInUse: 'This connection is currently in use and cannot be changed.',
          preferredConnectionUnavailable:
            'The preferred connection is unavailable. Choose another one in External Apps.',
        },
      },
      agentic: {
        ...
        invalidArgumentsCorrected: 'Corrected arguments for {skill} · {tool}',
        invalidArgumentsCorrectedDetail:
          'An earlier call failed argument validation. The model corrected the arguments and a later call succeeded.',
        strategyAdjusted: 'Adjusted execution strategy',
        navigationAlreadyThere: 'Already on {target}',
        navigationRunning: 'Navigating to {target}',
        navigationFailed: 'Could not navigate to {target}',
        navigationSucceeded: 'Navigated to {target}',
      },
    },
    memory: {
      title: 'Memory',
  ...
  appLogs: {
    ...
    agentTitle: 'Runtime Logs',
    agentSubtitle: '{name} · Review runs from user sessions, debugging, and API calls.',
    workflowTitle: 'Runtime Logs',
    workflowSubtitle:
      '{name} · Review workflow runs from apps, APIs, internal calls, and automation.',
    viewLogs: 'View Logs',
    viewRunDetail: 'View Run Detail',
    openAgent: 'Open Agent',
    openWorkflowApp: 'Open Workflow App',
    ...
    conversationDialogTitle: 'Conversation messages',
    conversationDialogDescription:
      'Review messages in this conversation and switch to the corresponding run.',
    currentTurn: 'Current',
    switchToTurn: 'Switch to this turn',
    noRunForMessage: 'This message is not linked to a run',
    ...
    loadErrorTitle: 'Could not load logs',
    loadErrorDescription: 'Run history is temporarily unavailable. Try again shortly.',
    selectRunTitle: 'Select a run',
    selectRunDescription: 'Choose a run to inspect its execution, inputs, and outputs.',
    deepLinkedRunHint:
      'This run was opened from a direct link and has not been loaded into the current list. Only the execution information currently available is shown.',
    noMessagesTitle: 'No conversation content',
    noMessagesDescription: 'No saved messages are available for this run.',
    messageNotFoundTitle: 'This message is not in the current list',
    messageNotFoundDescription:
      'The selected run is not included in the conversation content currently loaded. Return to the run list and select it again.',
    query: 'Query',
    answer: 'Answer',
    noQuery: 'No user input recorded',
    noAnswerYet: 'No response generated',
    empty: {
      filteredTitle: 'No logs match these filters',
      filteredDescription: 'Try changing the keyword, conversation ID, or log source.',
      clearFilters: 'Clear filters',
      agentTitle: 'No Agent logs yet',
      agentDescription: 'Runs will appear here after someone starts using this Agent.',
      consoleTitle: 'No debug logs yet',
      consoleDescription: 'Runs will appear here after you debug the Agent in the editor.',
      externalApiTitle: 'No API calls yet',
      externalApiDescription: 'Runs will appear here after this Agent is called through the API.',
      workflowTitle: 'No app calls yet',
      workflowDescription: 'Runs will appear here after this workflow is used in an app.',
      workflowSourceTitle: 'No {source} runs yet',
      workflowSourceDescription:
        'Runs will appear here after this workflow is started through {source}.',
    },
    filters: {
      ...
      copyRunIdFailed: 'Failed to copy run ID',
