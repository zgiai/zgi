  ...
  consoleChat: {
    ...
    governance: {
      ...
      approvalPanel: {
        ...
        fileDeleteOne: 'Ready to delete file {name}.',
        fileDeleteMany: 'Ready to delete {count} files.',
        genericOne: 'Ready to {effect} {assetType} {name}.',
        genericMany: 'Ready to {effect} {count} {assetType}.',
        generic: 'Ready to run this tool.',
