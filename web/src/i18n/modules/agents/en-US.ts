const messages = {
  ...
  workflow: {
    ...
    nodeDebug: {
      ...
      recordCreated: 'Run completed and was added to Debug Logs.',
      recordUnavailable: 'Run completed, but no viewable debug log was created.',
      viewRecord: 'View Debug Logs',
    ...
    features: {
      ...
      suggestedQuestions: {
        ...
        queryNotUsed:
          'This workflow does not use the user message, so meaningful suggested questions cannot be generated.',
        contextInsufficient:
          'This workflow does not provide enough user-facing context to generate reliable suggested questions.',
        empty:
    ...
    toolbar: {
      mouse: 'Mouse Mode',
      mouseTooltip: 'Mouse Mode (M)',
      trackpad: 'Trackpad Mode',
      trackpadTooltip: 'Trackpad Mode (T)',
      zoomOut: 'Zoom Out',
      fitView: 'Fit View',
      zoomIn: 'Zoom In',
      undo: 'Undo',
    ...
    debugRuns: 'Debug Logs',
    debugRunsDescription:
      'Only shows runs created while debugging the current draft in the editor.',
    noRuns: 'No runs yet',
    ...
    status: {
      ...
      resuming: 'Resuming',
      succeeded: 'Succeeded',
      partialSucceeded: 'Partially succeeded',
      failed: 'Failed',
      stopped: 'Stopped',
      stopping: 'Stopping',
      paused: 'Paused',
      ...
      pendingQuestion: 'Awaiting response',
      pendingClientAction: 'Awaiting page action',
      pendingUserInput: 'Awaiting user input',
      retrying: 'Retrying',
      submitted: 'Submitted',
      approved: 'Approved',
      rejected: 'Rejected',
    ...
    webapp: 'Web App',
    agentLogs: 'Runtime Logs',
    workflowLogs: 'Runtime Logs',
    webappLogs: 'Runtime Logs',
    webappStatus: {
  ...
  agentRuntime: {
    ...
    database: {
      ...
      addTable: 'Add table',
      addTableForDatabase: 'Add table for {name}',
      ...
      makeSelectedTablesWritable: 'Make selected writable',
    ...
    memoryValues: {
      ...
      userRequired: 'Enter a user ID first.',
      load: 'Load',
      loading: 'Loading memory...',
      empty: 'No memory has been written for this user yet.',
      noDescription: 'No description',
      updatedAt: 'Updated: {time}',
      contentPlaceholder: 'Enter memory content',
      overLimit: 'Content exceeds this memory item limit.',
      save: 'Save',
      clear: 'Clear',
      close: 'Close',
      saveSuccess: 'Memory saved',
      saveFailed: 'Failed to save memory',
      clearSuccess: 'Memory cleared',
      clearFailed: 'Failed to clear memory',
      loadFailed: 'Failed to load memory',
      clearConfirmTitle: 'Clear this memory?',
      clearConfirmDescription:
        'The current content will be forgotten for this user. The event log will not keep the original content.',
      clearConfirmAction: 'Clear memory',
