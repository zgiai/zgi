const messages = {
  ...
  batchImport: {
    title: 'Batch Import',
    steps: { file: 'Choose file', mapping: 'Field mapping', preview: 'Data preview', result: 'Result' },
    analyze: 'Analyze',
    previous: 'Previous',
    ...
    matchRateDesc: 'Based on the best one-to-one matches between Excel and target fields',
    modelEnriching: 'Adding semantic suggestions without blocking',
    modelSuggested: 'Semantic match suggested by the model',
    matchingTitle: 'Matching fields',
    matchingSubtitle: 'Matching field names, SQL columns, and sample values.',
    matchingDesc: 'Please wait. Exact matches, suggestions, and fields that still need attention will appear when matching finishes.',
    matchingProgress: 'Matching fields, please wait…',
    firstMatchHintTitle: 'Review suggestions for the first match',
    firstMatchHintDesc: 'This table has no confirmed mapping history yet. Confirm these suggestions once and matching headers will be exact next time.',
    lowMatchTitle: 'Low field match',
    lowMatchDesc: 'Review the mapping or create a new table with Import Excel. You may still continue.',
    sourceField: 'Excel field',
    targetField: 'Target field',
    status: 'Match',
    action: 'Action',
    matchStatus: { exact: 'Exact', possible: 'Possible', unmatched: 'Unmatched' },
    ...
    rowNumber: 'Row {row}',
    mappingTitle: 'Confirm field mapping',
    mappingSubtitle: 'Fields were matched from names, SQL names, and sample values.',
    selectedFileMeta: 'Excel file',
    selectedSheetMeta: 'Sheet: {sheet}',
    selectSheetTitle: 'Select worksheet',
    selectSheetDesc: '{count} worksheets were found. Select the worksheet to import.',
    selectSheetPlaceholder: 'Select a worksheet',
    sheetRows: '{count} rows',
    sheetLoading: 'Reading worksheets…',
    sheetSize: '{rows} rows, {columns} columns',
    confirmSheet: 'Confirm worksheet',
    ...
    confirmed: 'Confirmed',
    allHandled: 'All fields handled',
    pendingMappingCount: '{count} fields still need confirmation or handling',
    backToMapping: 'Back to field mapping',
    previewTitle: 'Data preview draft',
    previewSubtitle: 'Review converted values, fix invalid cells, and select rows to import.',
    searchPreview: 'Search draft data',
    onlyValidRows: 'Import valid rows only',
    row: 'Row',
    processingResult: 'Result',
    rowStatus: { valid: 'Ready', failed: 'Needs attention', skipped: 'Skipped' },
    previewSummary: '{failed} rows still contain errors. Fix them or deselect them.',
    previewReady: 'All rows passed validation and are ready to import.',
    confirmImport: 'Confirm import',
    resultTitle: 'Import result',
    processed: 'has been processed.',
    importCompleted: 'Data import completed',
    existingDataUntouched: 'New rows were added to this table. Existing data was not changed.',
    failedDataDesc: 'These rows were not written. You can correct and import them again.',
    failureReason: 'Failure reason',
    backToTable: 'Back to current table',
    confirmDialogTitle: 'Import new rows?',
    confirmDialogDesc: '{imported} rows will be added and {skipped} rows skipped. Existing data will not be changed.',
