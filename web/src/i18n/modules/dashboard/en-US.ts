const messages = {
  ...
  items: {
    ...
    invocationLogs: 'LLM Invocation Log',
  ...
  usage: {
    ...
    subtitle: 'Track token usage and cost across your organization',
    ...
    cards: {
      ...
      officialPoints: 'Official Cost',
      officialPointsHint: 'Settled through official providers',
      privatePoints: 'Private Cost',
      privatePointsHint: 'Settled through private channels',
      totalPoints: 'Total Cost',
      pointsConsumption: 'Cost',
      pointsConsumptionHint: 'Total cost under the current filters',
    ...
    modelDetails: {
      ...
      pointsConsumption: 'Cost',
      share: 'Cost Share',
      totalModels: 'Total {count} models, {total}',
      inputTotal: 'Input: {tokens} tokens',
      cacheReadTotal: 'Cache read: {tokens} tokens',
      cacheWriteTotal: 'Cache write: {tokens} tokens',
      outputTotal: 'Output: {tokens} tokens',
      empty: 'No model usage data for the selected filters',
    },
    appTypeDistribution: {
      title: 'App Type Distribution',
      subtitle: 'Cost split by attributed application type',
      attempts: 'Route Attempts',
      totalPoints: 'Total Cost',
      empty: 'No app type distribution data for the selected filters',
    },
    invocations: {
      title: 'LLM Invocation Log',
      subtitle:
        'Inspect every model call routed through the Gateway by source, business area, and model.',
      description: 'Gateway attempts are grouped into logical business calls.',
      loadFailed: 'Failed to load invocation log',
      loadFailedDescription:
        'The request did not complete successfully. Check the connection and try again.',
      retry: 'Retry',
      retrying: 'Retrying...',
      empty: 'No LLM calls in this time range',
      loadMore: 'Load more',
      loadingMore: 'Loading...',
      ...
      details: {
        ...
        totalTokens: 'Total tokens',
        cost: 'Cost',
        pointsAndPrice: 'Points (price)',
        pointsAndPriceValue: '{points} points/{price}',
        settlementDetails: 'Settlement details',
        platformSettlement: 'ZGI Cloud platform settlement',
        privateSettlement: 'Local model pricing',
        settlementUnknown: 'Historical settlement record',
        settledUSD: 'Settled amount (USD)',
        settledCNY: 'Settled amount (CNY)',
        callTimeExchangeRate: 'Exchange rate at call time',
        callTimeExchangeRateValue: '1 USD = {rate} CNY',
        callTimeCurrency: 'Display currency at call time',
        pricingSource: 'Price source',
        pricingSourceUpstream: 'Synced model price',
        pricingSourceConfigured: 'Model price (legacy source not distinguished)',
        pricingSourceOrganization: 'Organization override',
        pricingSourceAdminFallback: 'Administrator fallback price',
        pricingSourceCodeFallback: 'System fallback price',
        pricingSourceUnknown: 'Recorded settlement price',
        item: 'Item',
        tokens: 'Tokens',
        unitPrice: 'Actual unit price',
        subtotal: 'Subtotal',
        detailUnavailable: 'Not provided',
        formula: 'Calculation',
        perMillionTokens: '{price}/1M tokens',
        componentFormula: '{tokens} × {unitPrice} ÷ 1,000,000',
        platformFormula: '{points} points ÷ 1,000 = {cost}',
        platformFormulaCNY: '{points} points ÷ 1,000 × {rate} (call-time rate) = {cost}',
        componentTotalFormula: '= {cost}',
        platformBreakdownUnavailable:
          'ZGI Cloud returned the authoritative settled amounts and call-time exchange rate, but did not provide component unit prices. Model catalog prices are not substituted.',
        historicalBreakdownUnavailable:
          'This historical record does not contain a pricing snapshot, so only the settled total is available.',
        error: 'Error',
    ...
    chart: {
      pointsDistribution: 'Cost Distribution',
      ...
      dailyTrendSubtitle: 'Switch between cost and token views for the selected time range',
      totalPointsSeries: 'Total Cost',
      pointConsumptionSeries: 'Cost',
