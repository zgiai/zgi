...
const messages = {
  ...
  enterLoginCode: 'Enter the 6-digit code',
  useEmailCode: 'Sign in with email code',
  ...
  invitationActivation: {
    ...
    invalid: 'This invitation link is invalid. Ask the inviter to send a new one.',
    expired: 'This invitation has expired. Ask the inviter to send a new one.',
  ...
  joinRequestSubmittedDesc:
    'Your request has been submitted and is waiting for an administrator to approve it. You will be able to access the organization after approval.',
  failedToJoin: 'Failed to join',
  inviteAcceptErrors: {
    alreadyMember: 'You are already a member of this organization.',
    pendingApproval: 'Your join request is pending approval.',
    invalidToken: 'This invite link is invalid.',
    inactive: 'This invite link is not active.',
    expired: 'This invite link has expired.',
    memberNameExists: 'This member name already exists. Please use a different name.',
    loginRequired: 'Please sign in before joining the organization.',
  },
  ...
  sendCodeFirst: 'Please send a verification code first',
