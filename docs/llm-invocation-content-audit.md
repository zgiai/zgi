...
- Gateway requests only attempt a non-blocking enqueue. Queue pressure or a
  database outage drops the optional content copy without affecting the model
  response, billing, or invocation metadata.
