...
type Message struct {
	...
	ConversationID      uuid.UUID              `gorm:"type:uuid;not null;index:idx_chat_runtime_messages_conversation_created,priority:1" json:"conversation_id"`
	ParentID            *uuid.UUID             `gorm:"type:uuid;index:idx_chat_runtime_messages_parent" json:"parent_id,omitempty"`
