...
func (s *service) MigrateWebAppConversation(ctx context.Context, scope Scope, sourceConversationID uuid.UUID) (*runtimemodel.Conversation, error) {
...
func (s *service) existingMigratedConversation(ctx context.Context, scope Scope, sourceConversationID uuid.UUID) (*runtimemodel.Conversation, error) {
...
func (s *service) runWebAppMigration(ctx context.Context, scope Scope, source *oldconversation.AgentConversation, workspaceID *uuid.UUID) (*runtimemodel.Conversation, error) {
	var migrated *runtimemodel.Conversation
...
func newMigratedConversation(scope Scope, source *oldconversation.AgentConversation, workspaceID *uuid.UUID) *runtimemodel.Conversation {
	sourceID := source.ID
...
func setMigratedWebAppID(conversation *runtimemodel.Conversation, webAppIDRaw *string) {
...
func createMigratedMessages(tx *gorm.DB, conversation *runtimemodel.Conversation, sourceMessages []oldconversation.AgentMessage) error {
...
func newMigratedMessage(conversationID uuid.UUID, parentID *uuid.UUID, oldMessage oldconversation.AgentMessage) *runtimemodel.Message {
	oldID := oldMessage.ID
...
func updateMigratedConversationLeaf(tx *gorm.DB, conversation *runtimemodel.Conversation) error {
	if conversation.CurrentLeafMessageID == nil {
		return nil
	}
	err := tx.Model(&runtimemodel.Conversation{}).
