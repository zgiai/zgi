...
func aiChatActionPlannerSystemPrompt() string {
	return strings.Join([]string{
		...
		`Schema: {"matched":true|false,"confidence":0.0,"capability_id":"available capability id or empty","intent":"short stable intent","resource_refs":[{"type":"file","id":"exact resource id when known","file_id":"exact file id when known","selector":"visible_files[4] when referring to visible order","scope":"selected|recent when the user refers to selected/current or previous/recent assets","visible_index":4,"ordinal":2,"ordinal_text":"last","name":"optional exact/fuzzy name","title_contains":"optional contained title text","extension":"pdf","file_type":"excel"}],"postprocess":[{"type":"translate","target_language":"optional language"},{"type":"summarize"}],"reason":"short internal reason"}`,
		...
		`For previous or recent file references: "that previous file" or "the recent file" => {"type":"file","scope":"recent"}.`,
		"For Chinese previous or recent file references: \"\u521a\u624d\u90a3\u4e2a\u6587\u4ef6\" or \"\u4e0a\u6b21\u90a3\u4e2a\u8d44\u4ea7\" => {\"type\":\"file\",\"scope\":\"recent\"}.",
