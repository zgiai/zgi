...
func M0037_create_data_library_foundation_tables() *gormigrate.Migration {
	return &gormigrate.Migration{
		ID: migrationV2DataLibraryFoundationID,
		...
		Rollback: func(tx *gorm.DB) error {
			statements := []string{
				`ALTER TABLE data_library_database_asset_refs DROP CONSTRAINT IF EXISTS fk_data_library_db_asset_refs_extraction_artifact`,
				`DROP TABLE IF EXISTS data_library_extraction_artifacts`,
				`DROP TABLE IF EXISTS data_library_database_asset_refs`,
				`DROP TABLE IF EXISTS data_library_knowledge_base_asset_refs`,
				`DROP TABLE IF EXISTS data_library_vector_artifacts`,
				`DROP TABLE IF EXISTS data_library_processing_requests`,
				`DROP TABLE IF EXISTS data_library_reuse_events`,
