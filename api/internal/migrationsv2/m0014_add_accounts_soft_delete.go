...
// M0014_add_accounts_soft_delete adds GORM soft-delete support to accounts.
func M0014_add_accounts_soft_delete() *gormigrate.Migration {
	return &gormigrate.Migration{
		ID: migrationV2AddAccountsSoftDeleteID,
