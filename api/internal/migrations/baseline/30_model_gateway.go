...
var ModelGatewaySchema = File{
    ...
    replacement_provider character varying(100),
    replacement_model character varying(100),
    ...
    config_parameters jsonb DEFAULT '[]'::jsonb NOT NULL
		...
		`COMMENT ON COLUMN public.llm_models.replacement_provider IS 'Suggested replacement provider for deprecated models';`,
		`COMMENT ON COLUMN public.llm_models.replacement_model IS 'Suggested replacement model for deprecated models';`,
		`COMMENT ON COLUMN public.llm_models.deprecation_reason IS 'Optional reason shown for deprecated models';`,
