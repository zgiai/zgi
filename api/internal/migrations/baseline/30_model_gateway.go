...
var ModelGatewaySchema = File{
    ...
    cost_cache_read numeric(24,12) DEFAULT 0,
    cost_cache_write numeric(24,12) DEFAULT 0,
    cost_cache_write_5m numeric(24,12) DEFAULT 0,
    cost_cache_write_1h numeric(24,12) DEFAULT 0,
    cache_read_price_configured boolean DEFAULT false NOT NULL,
    cache_write_price_configured boolean DEFAULT false NOT NULL,
    cache_write_5m_price_configured boolean DEFAULT false NOT NULL,
    cache_write_1h_price_configured boolean DEFAULT false NOT NULL,
    ...
    cache_read_price_override numeric(24,12),
    cache_write_price_override numeric(24,12),
    cache_write_5m_price_override numeric(24,12),
    cache_write_1h_price_override numeric(24,12),
    ...
    cache_read_price_configured boolean DEFAULT false NOT NULL,
    cache_write_price_configured boolean DEFAULT false NOT NULL,
    cost_cache_write_5m numeric(24,12),
    cost_cache_write_1h numeric(24,12),
    cache_write_5m_price_configured boolean DEFAULT false NOT NULL,
    cache_write_1h_price_configured boolean DEFAULT false NOT NULL,
