...
func upCreateWorkflowAnnouncements(schema *mschema.Builder) error {
	return schema.Create("workflow_announcements", func(table *mschema.Blueprint) {
		table.ID()
		...
		table.TimestampsTz()
		table.Index("idx_workflow_announcements_tenant", "tenant_id")
		table.Index("idx_workflow_announcements_app", "app_id")
		table.Index("idx_workflow_announcements_run", "workflow_run_id")
		table.Index("idx_workflow_announcements_node", "node_id")
		table.Index("idx_workflow_announcements_expiration", "expiration_time")
		table.Unique("idx_workflow_announcements_access_token", "access_token")
		table.Unique("idx_workflow_announcements_run_node", "workflow_run_id", "node_id")
	})
}

func downCreateWorkflowAnnouncements(schema *mschema.Builder) error {
	return schema.DropIfExists("workflow_announcements")
}
