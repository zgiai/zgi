...
type Announcement struct {
	...
	WorkflowRunID   string    `gorm:"type:varchar(255);not null;index:idx_announcements_run" json:"workflow_run_id"`
	NodeID          string    `gorm:"type:varchar(255);not null;index:idx_announcements_node" json:"node_id"`
