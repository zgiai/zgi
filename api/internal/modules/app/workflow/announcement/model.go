...
type Announcement struct {
	...
	WorkflowRunID   string    `gorm:"type:varchar(255);not null;index;uniqueIndex:idx_announcements_run_node" json:"workflow_run_id"`
	NodeID          string    `gorm:"type:varchar(255);not null;index;uniqueIndex:idx_announcements_run_node" json:"node_id"`
