...
func (s *agentsService) GetPublishedAgentWebAppConfig(ctx context.Context, webAppID string) (*dto.AgentWebAppRuntimeConfigResponse, error) {
	...
	return s.publishedAgentRuntimeConfig(ctx, ag, true, true)
}
...
func (s *agentsService) GetPublishedAgentRuntimeConfig(ctx context.Context, agentID string) (*dto.AgentWebAppRuntimeConfigResponse, error) {
	...
	return s.publishedAgentRuntimeConfig(ctx, ag, false, false)
}

func (s *agentsService) publishedAgentRuntimeConfig(ctx context.Context, ag *Agent, requireActiveWebApp bool, failOnOrganizationError bool) (*dto.AgentWebAppRuntimeConfigResponse, error) {
	if ag == nil {
