...
type LLMModel struct {
	...
	InputPrice                  decimal.Decimal `gorm:"column:input_price;type:decimal(24,12)" json:"input_price,omitempty"`               // Price per million input tokens
	OutputPrice                 decimal.Decimal `gorm:"column:output_price;type:decimal(24,12)" json:"output_price,omitempty"`             // Price per million output tokens
	...
	CachedInputPrice            decimal.Decimal `gorm:"column:cached_input_price;type:decimal(24,12)" json:"cached_input_price,omitempty"` // Price per million cached input tokens (ModelMeta aligned)
	Pricing                     datatypes.JSON  `gorm:"column:pricing;type:jsonb;default:'{}'" json:"pricing,omitempty"`
	CostCacheRead               decimal.Decimal `gorm:"type:decimal(24,12)" json:"cost_cache_read,omitempty"`  // Cost per million cached tokens read
	CostCacheWrite              decimal.Decimal `gorm:"type:decimal(24,12)" json:"cost_cache_write,omitempty"` // Cost per million cached tokens write
	CostCacheWrite5m            decimal.Decimal `gorm:"column:cost_cache_write_5m;type:decimal(24,12)" json:"cost_cache_write_5m,omitempty"`
	CostCacheWrite1h            decimal.Decimal `gorm:"column:cost_cache_write_1h;type:decimal(24,12)" json:"cost_cache_write_1h,omitempty"`
	...
	CacheWrite5mPriceConfigured bool            `gorm:"column:cache_write_5m_price_configured;default:false" json:"cache_write_5m_price_configured"`
	CacheWrite1hPriceConfigured bool            `gorm:"column:cache_write_1h_price_configured;default:false" json:"cache_write_1h_price_configured"`
