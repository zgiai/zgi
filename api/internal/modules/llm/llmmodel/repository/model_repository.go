...
const availableModelColumns = "id, provider, name, display_name, status, use_cases, currency, input_price, output_price, input_price_configured, output_price_configured, cached_input_price, cost_cache_read, cost_cache_write, cache_read_price_configured, cache_write_price_configured, pricing, reasoning, function_calling, structured_output, temperature, top_p, presence_penalty, frequency_penalty, logit_bias, seed, stop, max_stop_sequences, vision, json_mode, streaming, chat_completions, embeddings, image_generation, speech_generation, transcription, music_generation, moderation, realtime, batch, assistants, responses, videos, image_edit, system_prompt, logprobs, web_search, file_search, code_interpreter, computer_use, mcp, parallel_tool_calls, reasoning_effort, context_window, max_output_tokens, input_modalities, output_modalities, supported_parameters, default_parameters, config_parameters, is_active"
