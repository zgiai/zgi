...
type AgentsService interface {
	...
	ListAgentMemoryValues(ctx context.Context, agentID, accountID, userScope, userID string) (*dto.AgentMemoryValuesResponse, error)
	...
	ClearAgentMemoryValue(ctx context.Context, agentID, accountID, userScope, userID, key string) (*dto.AgentMemoryValueResponse, error)
