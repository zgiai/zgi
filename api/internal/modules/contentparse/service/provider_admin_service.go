...
func (s *providerAdminService) ListByScope(ctx context.Context, scope string, workspaceID *uuid.UUID) ([]*model.ProviderConfig, error) {
	return s.repo.ListByScope(ctx, scope, workspaceID)
}
