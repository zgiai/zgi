...
func createSegmentVectorTestTables(t *testing.T, db *gorm.DB) {
	...
	statements := []string{
		`CREATE TABLE datasets (
			...
			graph_available_revision integer,
			graph_projected_revision integer,
			graph_visibility_revision integer,
			graph_projected_visibility_revision integer,
			graph_current_run_id text,
			graph_progress integer,
			graph_error_code text,
			graph_error_message text,
			graph_ready_at datetime,
