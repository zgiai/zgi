...
type CustomSkill struct {
	...
	OrganizationID  uuid.UUID              `gorm:"type:uuid;not null;index:idx_aichat_custom_skills_org_skill,unique" json:"organization_id"`
	SkillID         string                 `gorm:"type:varchar(128);not null;index:idx_aichat_custom_skills_org_skill,unique" json:"skill_id"`
