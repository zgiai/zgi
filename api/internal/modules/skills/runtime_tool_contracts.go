...
func skillToolArgumentContracts() map[string]SkillToolArgumentContract {
	return map[string]SkillToolArgumentContract{
		...
		SkillConsoleNavigator + "/navigate": {
			...
			Schema: objectSchema(
				map[string]interface{}{
					"href":   stringValueSchema("Required whitelisted internal /console route, such as /console/files, /console/agents, /console/workflows, /console/dataset, /console/db, /console/skills, /console/prompts, /console/work/task, /console/work/chat, /console/work/image, /console/work/app, or /console/workspace. Do not use external URLs."),
