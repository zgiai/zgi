...
type WorkspaceService interface {
	...
	UpdateWorkspace(ctx context.Context, tenantID, name string, status *model.WorkspaceStatus, userID string, hasWorkspacePermission bool) (*model.WorkspaceUpdateResponse, error)
