...
func TestPromptBuilderToolsRequireWorkspacePermissionBeforeBodyBinding(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantPermissions: []workspace_model.WorkspacePermissionCode{workspace_model.WorkspacePermissionAgentManage},
		...
		},
		{
			...
			wantPermissions: []workspace_model.WorkspacePermissionCode{workspace_model.WorkspacePermissionAgentView, workspace_model.WorkspacePermissionAgentManage},
