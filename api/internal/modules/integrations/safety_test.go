...
func TestDefaultSafetyCheckerBlocksSensitiveExternalInput(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "aws authorization", value: "Authorization: AWS4-HMAC-SHA256 Credential=AKIA" + "IOSFODNN7EXAMPLE/20260720/us-east-1/s3/aws4_request, Signature=abcdef1234567890"},
		...
		{name: "github pat", value: "ghp_" + "abcdefghijklmnopqrstuvwxyz1234567890"},
		{name: "github fine-grained pat", value: "github_pat_" + "11ABCDEFG0abcdefghijklmnopqrstuvwxyz_123456789"},
		{name: "jwt", value: "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiIxMjM0NTY3ODkwIn0.dBjftJeZ4CVP-mB92K27uhbUJU1p1r_wW1gFWFOEjXk"},
		{name: "aws access key", value: "AKIA" + "IOSFODNN7EXAMPLE"},
...
func TestValidateExternalWebURL(t *testing.T) {
	...
	blocked := []string{
		...
		"https://example.com/article?X-Amz-Credential=AKIA" + "IOSFODNN7EXAMPLE%2F20260720%2Fus-east-1%2Fs3%2Faws4_request&X-Amz-Signature=abcdef",
