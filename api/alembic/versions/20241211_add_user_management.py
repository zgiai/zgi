...
Revises: 2024_12_10_applications
...
down_revision = '2024_12_10_applications'  # Update this with your previous revision
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('users', sa.Column('preferences', mysql.JSON(), nullable=True))
