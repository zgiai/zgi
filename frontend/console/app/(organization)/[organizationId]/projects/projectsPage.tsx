    ...
    return <div className="flex flex-col gap-4 p-4">
        <div className="flex justify-between p-4 border-b border-gray-200 dark:border-gray-700/60 items-center flex-wrap gap-4">
            <div className="flex-1">
                <span className="text-2xl text-gray-800 dark:text-gray-100 font-bold">Projects</span>
            </div>
        </div>
...
function OrganizationCard({ organization, organizationId, userType }: { organization: any, organizationId: string, userType: number }) {
