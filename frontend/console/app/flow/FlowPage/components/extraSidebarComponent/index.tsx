  ...
  return (
    <div className="side-bar-arrangement">
      ...
      <ShadTooltip content={t('flow.exit')} side="bottom">
        <button className="extra-side-bar-buttons w-[80px] absolute right-4 top-4 bg-gray-0 z-10 rounded-r-full rounded-l-none" onClick={() => router.replace('/skill/' + flow.id)} >
